...
<Message kind="warning" title="Warning">
  For large lists, asynchronous selections and searching please use the {`<Select />`} component.
</Message>
...
<Playground>
  ...
  <Dropdown
    options={[
      ...
      { text: 'Last 2 hours', value: '2h' },
      { text: 'Last 8 hours', value: '8h' },
...
A dropdown with custom items

<Playground>
  <Dropdown
      selectedItem={{ key: 1 }}
      options={[
        { key: 0, content: <span>Span item</span>, value: 'span item' },
        { key: 1, content: <span>Correct option <Icon name='done' color='green' /></span>, value: 'short' }
      ]}
  />
</Playground>
...
<Playground>
  <Dropdown
    ...
    options={[
      { text: 'Foo', value: 'foo' },
      { text: 'Bar', value: 'bar' },
      { text: 'Thisisaveryveryveryveryveryveryveryveryverylongtext', value: 'foobar' }
    ]}
  />
</Playground>
...
<Playground>
  <div>
    <Dropdown
      options={[
        { text: 'Uzbekistan', value: 'Uzbekistan', group: 'Africa' },
        { text: 'Vanuatu', value: 'Vanuatu', group: 'Africa' },
        { text: 'Vatican City', value: 'Vatican City', group: 'Africa' },
        { text: 'Venezuela', value: 'Venezuela', group: 'Africa' },
        { text: 'Vietnam', value: 'Vietnam', group: 'Africa' },
        { text: 'Wallis and Futuna', value: 'Wallis and Futuna', group: 'Africa' },
        { text: 'Yemen', value: 'Yemen', group: 'Africa' },
        { text: 'Zambia', value: 'Zambia', group: 'Africa' },
        { text: 'Zimbabwe', value: 'Zimbabwe', group: 'Africa' },
        { text: 'Uzbekistan', value: 'Uzbekistan', group: 'Europe' },
        { text: 'Vanuatu', value: 'Vanuatu', group: 'Europe' },
        { text: 'Vatican City', value: 'Vatican City', group: 'Europe' },
        { text: 'Venezuela', value: 'Venezuela', group: 'Europe' },
        { text: 'Vietnam', value: 'Vietnam', group: 'Europe' },
        { text: 'Wallis and Futuna', value: 'Wallis and Futuna', group: 'Europe' },
        { text: 'Yemen', value: 'Yemen', group: 'Europe' },
        { text: 'Zambia', value: 'Zambia', group: 'Europe' },
        {
          text: 'AveryveryveryveryveryveryveryBigCountry',
          value: 'AveryveryveryveryveryveryveryBigCountry',
          group: 'thisaveryveryveryveryveryveryveryhugegroup'
        }
      ]}
    />
  </div>
...
<Playground>
  <div>
    <Dropdown
      options={[
        { text: 'Uzbekistan', value: 'Uzbekistan' },
        { text: 'Vanuatu', value: 'Vanuatu', disabled: true },
        { text: 'Vatican City', value: 'Vatican City' },
        { text: 'Venezuela', value: 'Venezuela' },
        { text: 'Vietnam', value: 'Vietnam' },
      ]}
